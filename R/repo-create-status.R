...
#' @examples \dontrun{
#' }
repo_create_status <- function(api_endpoint = Sys.getenv('GITEA_BASE_URL'),
  ...
  gitea_url <- file.path(api_endpoint, 'api/v1', s('^/', '', '/repos/{owner}/{repo}/statuses/{sha}'))
