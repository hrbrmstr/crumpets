#' WIP - Get an archive of a repository
#'
#' @md
...
#' @examples \dontrun{
#' }
repo_get_archive <- function(api_endpoint = Sys.getenv('GITEA_BASE_URL'),
  ...
  gitea_url <- file.path(api_endpoint, 'api/v1', '/repos/{owner}/{repo}/archive/{filepath}')
