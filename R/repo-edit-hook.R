#' WIP - Edit a hook in a repository
#'
#' @md
...
#' @examples \dontrun{
#' }
repo_edit_hook <- function(api_endpoint = Sys.getenv('GITEA_BASE_URL'),
  ...
  gitea_url <- file.path(api_endpoint, 'api/v1', '/repos/{owner}/{repo}/hooks/{id}')
