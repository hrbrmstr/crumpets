#' WIP - Get a file from a repository
#'
#' @md
...
#' @examples \dontrun{
#' }
repo_get_raw_file <- function(api_endpoint = Sys.getenv('GITEA_BASE_URL'),
  ...
  httr::VERB(
    verb = 'GET',
    url = 'http://bigd:3000/api/v1/repos/{owner}/{repo}/raw/{filepath}',
    body = list(),
    query = list(
