#' WIP - List a repo's pull requests
#'
#' @md
...
#' @examples \dontrun{
#' }
repo_list_pull_requests <- function(api_endpoint = Sys.getenv('GITEA_BASE_URL'),
  ...
  gitea_url <- file.path(api_endpoint, 'api/v1', '/repos/{owner}/{repo}/pulls')
