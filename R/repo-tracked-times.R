#' WIP - List a repo's tracked times
#'
#' @md
...
#' @examples \dontrun{
#' }
repo_tracked_times <- function(api_endpoint = Sys.getenv('GITEA_BASE_URL'),
  ...
  gitea_url <- file.path(api_endpoint, 'api/v1', '/repos/{owner}/{repo}/times')
